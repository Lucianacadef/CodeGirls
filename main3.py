...
myfont = pygame.font.SysFont('trench100free.ttf', 30)
myfont1 = pygame.font.SysFont('trench100free.ttf', 100)
myfont2 = pygame.font.SysFont('trench100free.ttf', 15)
fim = myfont1.render('Você venceu!!!!!!', False, (255,255,255))
gameover = myfont1.render('Game Over...',False, (255,255,255))
proxnivel = myfont.render('Proximo nivel',False, (255,255,255))
...
while True:
	...
	if tela_atual == "intro":
		...
		#---------------------------------#
			...
			fontpont = pygame.font.Font('trench100free.ttf', 40)		
